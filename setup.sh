...
az cosmosdb mongodb collection create --account-name  gscosmosdb --database-name mydatabase --name mycollection --resource-group GSResource --shard 'key' --throughput 400

az cosmosdb mongodb collection create --account-name gscosmosdb  --database-name mydatabase --name ml-collection --resource-group GSResource --shard 'key' --throughput 400
